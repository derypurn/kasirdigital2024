            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">DETAIL PENJUALAN</a>
                    </div>
                        ...
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <a href="formtambah_detail.php" class="btn btn-info mb-4"><i class="tim-icons icon-simple-add"></i>&emsp;Tambah Data</a>
                                        ...
                                        <tbody>
                                            ...
                                            while ($tampil = $ambildata->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $tampil["qty"] ?></td>
                                                    <td>Rp. <?= number_format($tampil["subtotal"], 2, ",", ".") ?></td>
                                                    <td>
