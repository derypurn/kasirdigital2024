...
$query = $koneksi->query("SELECT * FROM pelanggan WHERE id=$pelanggan_id");
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Edit Data Pelanggan</a>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="id" class="form-control" placeholder="ID Pelanggan" value="<?= $data['id']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nama Pelanggan" value="<?= $data['nama']; ?>" name="nama" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                <label>Alamat</label>
                                                <input type="text" class="form-control" placeholder="Alamat" value="<?= $data['alamat']; ?>" name="alamat" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                <label>Telepon</label>
                                                <input type="Number" class="form-control" placeholder="Telepon" value="<?= $data['telepon']; ?>" name="telepon" required>
                                            </div>
                                        </div>
                                    </div>
