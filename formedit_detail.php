...
$query = $koneksi->query("SELECT * FROM detailpenjualan WHERE id=$detail_id");
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Edit Data Detail</a>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title ml-4 mt-4">Edit Data</h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="id" class="form-control" placeholder="ID Detail" value="<?= $data['id']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="ID Penjualan" value="<?= $data['penjualan_id']; ?>" name="penjualan_id" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="ID Produk" value="<?= $data['produk_id']; ?>" name="produk_id" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Jumlah Total" value="<?= $data['qty']; ?>" name="qty" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                <label>Subotal</label>
                                                <input type="number" class="form-control" placeholder="Subtotal" value="<?= $data['subtotal']; ?>" name="subtotal" required>
                                            </div>
                                        </div>
                                    </div>
