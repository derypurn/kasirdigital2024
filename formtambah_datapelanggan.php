...
$sql = "SELECT MAX(id) AS last_id FROM pelanggan";
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Tambah Data pelanggan</a>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-general ml-4" style="font-size: 10px;">*Lihat dulu id pelanggan terakhir di <a href="table_pelanggan.php">table pelanggan</a>.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="id" class="form-control" placeholder="ID Pelanggan" value="<?= $last_id ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
