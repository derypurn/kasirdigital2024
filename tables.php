      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:void(0)">DATA</a>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter" id="">
                    ...
                    while ($tampil = $ambildata->fetch_assoc()) { ?>
                      <tr>
                        ...
                        <td><?= $tampil["stok"] ?></td>
                        <td>
                          <a href="formedit_produk.php?id=<?= $tampil['id'] ?>" class="btn btn-success p-3"><i class="tim-icons icon-pencil"></i></a>&emsp;
                          <form action="hapus_data.php" method="POST">
                            <input type="hidden" value="<?= $tampil['id'] ?>" name="id">
                            <button class="btn btn-danger p-3"><i class="tim-icons icon-trash-simple"></i></button>
                          </form>
                        </td>
                      </tr>
                    <?php } ?>
                  ...
                  <a href="formtambah_data.php" class="btn btn-info"><i class="tim-icons icon-simple-add"></i>&emsp;Tambah Data</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card card-plain">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <a href="formtambah_penjualan.php" class="btn btn-info"><i class="tim-icons icon-simple-add"></i>&emsp;Tambah Data</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      while ($tampil = $ambildata->fetch_assoc()) { ?>
                        <tr>
                          ...
                          <td><?= $tampil["nama"] ?></td>
                          <td><?= $tampil["alamat"] ?></td>
                          <td>+62 <?= $tampil["telepon"] ?></td>
                          <td>
                            <a href="formedit_pelanggan.php?id=<?= $tampil['id'] ?>" class="btn btn-success p-3"><i class="tim-icons icon-pencil"></i></a>&emsp;
                            <form action="hapus_datapelanggan.php" method="POST">
                              <input type="hidden" value="<?= $tampil['id'] ?>" name="id">
                              <button class="btn btn-danger p-3"><i class="tim-icons icon-trash-simple"></i></button>
                            </form>
                          </td>
                  ...
                  <a href="formtambah_datapelanggan.php" class="btn btn-info"><i class="tim-icons icon-simple-add"></i>&emsp;Tambah Data</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="table-responsive">
                <table class="table tablesorter" id="">
                  ...
                  <tbody>
                    <?php
                    $no = 1;
                    $ambildata = $koneksi->query("select * from detailpenjualan");
                    while ($tampil = $ambildata->fetch_assoc()) { ?>
                      <tr>
                        <td><?= $no++ ?></td>
                        <td><?= $tampil["id"] ?></td>
                        <td><?= $tampil["penjualan_id"] ?></td>
                        <td><?= $tampil["produk_id"] ?></td>
                        <td><?= $tampil["qty"] ?></td>
                        <td><?= $tampil["subtotal"] ?></td>
                        <td>
                          <a href="formedit_detail.php?id=<?= $tampil['id'] ?>" class="btn btn-success p-3"><i class="tim-icons icon-pencil"></i></a>&emsp;
                          <form action="hapus_datadetail.php" method="POST">
                            <input type="hidden" value="<?= $tampil['id'] ?>" name="id">
                            <button class="btn btn-danger p-3"><i class="tim-icons icon-trash-simple"></i></button>
                          </form>
                        </td>
                ...
                <a href="formtambah_detail.php" class="btn btn-info"><i class="tim-icons icon-simple-add"></i>&emsp;Tambah Data</a>
              </div>
            </div>
          </div>
        </div>
