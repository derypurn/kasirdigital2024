...
$query = $koneksi->query("SELECT * FROM produk WHERE id=$produk_id");
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Edit Data Produk</a>
                    </div>
                                ...
                                <form method="post" action="edit_produk.php">
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="id" class="form-control" placeholder="ID Produk" value="<?= $data['id']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nama Produk" value="<?= $data['nama']; ?>" name="nama" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                <label>Stok</label>
                                                <input type="Number" class="form-control" placeholder="Stok" value="<?= $data['stok']; ?>" name="stok" required>
                                            </div>
                                        </div>
                                    </div>
