...
$query = $koneksi->query("SELECT * FROM penjualan WHERE id=$penjualan_id");
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Edit Data Penjualan</a>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="id" class="form-control" placeholder="ID Penjualan" value="<?= $data['id']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" placeholder="Tanggal Penjualan" value="<?= $data['tgl_penjualan']; ?>" name="tgl_penjualan" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Total Harga" value="<?= $data['total_harga']; ?>" name="total_harga" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="Number" class="form-control" placeholder="ID Pelanggan" value="<?= $data['pelanggan_id']; ?>" name="pelanggan_id" required>
                                            </div>
                                        </div>
                                    </div>
