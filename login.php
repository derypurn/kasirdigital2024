            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-chart">
                            <div class="card-header">
                                <h3 class="card-title ml-4">LOGIN</h3>
                                <form action="ceklogin.php" class="ml-4" method="post">
                                    <div class="row">
                                    ...
                                    <button type="submit" name="submit" id="submit" class="btn btn-primary mb-2">Submit</button>
                                </form>
                                <div class="col-md-8 pr-md-1 mb-4">
                                    <a href="register.php" class="text-general ml-2 mt-4">Buat akun</a>
                                </div>
                            </div>
                        </div>
                    </div>
