            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Tambah Data penjualan</a>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-general ml-4" style="font-size: 10px;">*Lihat dulu id terakhir di <a href="table_penjualan.php">tabel penjualan.</a><br>Sesuaikan ID pelanggan sebagaimana di table pelanggan.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="id" class="form-control" placeholder="ID Penjualan" value="<?= $last_penjualan ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" placeholder="Tanggal Penjualan" name="tgl_penjualan" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Total Harga" name="total_harga" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 pr-md-1 ml-4">
                                            <div class="form-group">
                                                ...
                                                <input type="Number" class="form-control" placeholder="ID Pelanggan" value="3001" name="pelanggan_id" required>
                                            </div>
                                        </div>
                                    </div>
