            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">DATA PRODUK</a>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <a href="formtambah_data.php" class="btn btn-info mb-4"><i class="tim-icons icon-simple-add"></i>&emsp;Tambah Data</a>
                                    ...
                                    <!-- <form method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col"></div>
                                            <div class="col">
                                                <input type="text" class="form-control sm-8" name="keyword">
                                            </div>
                                            <div class="col">
                                                <input type="submit" class="btn btn-warning btn-sm" name="cari" value="cari">
                                            </div>
                                        </div>
                                    </form> -->
